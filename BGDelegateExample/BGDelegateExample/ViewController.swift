...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // Action will be delegate from ViewController to SecondViewController, where
        // the action will be done. So self (ViewController) delegates (self.delegate)
        // to second ViewController.
        self.delegate = secondViewController
        // Otherwise if the action is done in this class, the SecondViewController
        // delegates here the action: secondViewController.delegate = self
